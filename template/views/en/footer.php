...
<footer>
  ...
  <div id="littleMenu2">
    ...
    <div id="menuWrap2">
      <div id="menu2">
        <a href="/ru/books"><img src="/template/img/books.png" alt="" /> Promotions</a>
        <a href="/ru"><img src="/template/img/logo.png" alt="" /> Catalog</a>
        <a href="/ru/frends"><img src="/template/img/news.png" alt="" /> Delivery</a>
        <a href="/ru/inspiration"><img src="/template/img/insp.png" alt="" /> Contacts</a>
      </div>
    </div>
  </div>
</footer>
...
<div id="chat-panel">
  <div id="chat-header"><img src="/template/img/5.png" />Chat</div>
  <div id="chat-body">
    <div id="chat-messages">
      <ul></ul>
    </div>
    <form id="chat-form" method="post">
      <input type="text" name="name" id="name" placeholder="Your name (will remember)" value="">
      <textarea id="chat-input" name="message_text" id="message_text" placeholder="Write a message..."></textarea>
